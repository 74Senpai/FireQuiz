...
export const createQuestion = asyncHandler(async (req, res) => {
  const user = req.user;
  const { content, type, quizId, answers, explanation } = req.body;
  ...
  const id = await questionService.createQuestion(user, { content, type, quizId, answers: answers || [], explanation });
