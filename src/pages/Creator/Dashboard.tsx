          ...
          >
            ...
            <CardHeader className="pb-2 relative z-10">
              <div className="flex items-start justify-between">
                <CardTitle className="text-lg font-bold line-clamp-1 text-slate-100 group-hover:text-white transition-colors duration-300">{quiz.title}</CardTitle>
            ...
            <CardContent className="relative z-10">
              <div className="grid grid-cols-2 gap-4 text-sm text-slate-300 mt-4 p-3 bg-white/5 rounded-lg backdrop-blur-sm group-hover:bg-white/10 transition-colors duration-300">
